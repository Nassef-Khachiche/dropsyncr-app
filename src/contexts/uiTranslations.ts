...
const phrases: PhraseEntry[] = [
  ...
  { en: 'Earliest drop-off date', nl: 'Vroegste inleverdatum', de: 'Frühestes Abgabedatum' },
  { en: 'Latest drop-off date', nl: 'Uiterste inleverdatum', de: 'Spätestes Abgabedatum' },
  ...
  { en: 'manual review', nl: 'handmatig controleren', de: 'manuell prüfen' },
  ...
  { en: 'Connect your Bol.com shop for automated order processing', nl: 'Koppel je Bol.com winkel voor geautomatiseerde orderverwerking', de: 'Verbinde deinen Bol.com-Shop für die automatische Bestellverarbeitung' },
  { en: 'Select an installation first in the top-right to manage integrations', nl: 'Selecteer eerst een installatie rechtsboven om integraties te beheren', de: 'Wähle oben rechts zuerst eine Installation, um Integrationen zu verwalten' },
  ...
  { en: 'Only Bol.com sync is currently supported', nl: 'Alleen Bol.com sync wordt momenteel ondersteund', de: 'Derzeit wird nur die Bol.com-Synchronisierung unterstützt' },
  { en: 'Select a specific store to sync orders', nl: 'Selecteer een specifieke store om orders te synchroniseren', de: 'Wähle einen bestimmten Store, um Bestellungen zu synchronisieren' },
  { en: 'Orders synchronized!', nl: 'Orders gesynchroniseerd!', de: 'Bestellungen synchronisiert!' },
  { en: 'Could not sync orders', nl: 'Kon orders niet synchroniseren', de: 'Bestellungen konnten nicht synchronisiert werden' },
  ...
  { en: 'Connect all your sales channels and manage all orders from one central place. Dropsyncr automatically synchronizes your inventory and orders between all platforms.', nl: 'Koppel al je verkoopkanalen en beheer alle orders vanaf één centrale plek. Dropsyncr synchroniseert automatisch je voorraad en orders tussen alle platforms.', de: 'Verbinde alle deine Verkaufskanäle und verwalte alle Bestellungen von einem zentralen Ort aus. Dropsyncr synchronisiert automatisch deinen Bestand und deine Bestellungen zwischen allen Plattformen.' },
  ...
  { en: 'Help documentation is loading...', nl: 'Help documentatie wordt geladen...', de: 'Hilfedokumentation wird geladen...' },
  ...
  { en: 'Leave empty to keep current Client ID', nl: 'Laat leeg om huidige Client ID te behouden', de: 'Leer lassen, um die aktuelle Client-ID zu behalten' },
  { en: 'Leave empty to keep current API key', nl: 'Laat leeg om huidige API key te behouden', de: 'Leer lassen, um den aktuellen API-Schlüssel zu behalten' },
  { en: 'Enter your Client ID', nl: 'Voer je Client ID in', de: 'Gib deine Client-ID ein' },
  { en: 'Enter your API key', nl: 'Voer je API key in', de: 'Gib deinen API-Schlüssel ein' },
  { en: 'API Key', nl: 'API Key', de: 'API-Schlüssel' },
  { en: 'API Secret', nl: 'API Secret', de: 'API-Secret' },
  { en: 'Leave empty to keep current Client Secret', nl: 'Laat leeg om huidige Client Secret te behouden', de: 'Leer lassen, um das aktuelle Client-Secret zu behalten' },
  { en: 'Leave empty to keep current API secret', nl: 'Laat leeg om huidige API secret te behouden', de: 'Leer lassen, um das aktuelle API-Secret zu behalten' },
  { en: 'Enter your Client Secret', nl: 'Voer je Client Secret in', de: 'Gib dein Client-Secret ein' },
  { en: 'Enter your API secret', nl: 'Voer je API secret in', de: 'Gib dein API-Secret ein' },
  ...
  { en: 'Select a specific store to add an integration', nl: 'Selecteer een specifieke store om een integratie toe te voegen', de: 'Wähle einen bestimmten Store, um eine Integration hinzuzufügen' },
  { en: 'Platform settings not found', nl: 'Platform instellingen niet gevonden', de: 'Plattformeinstellungen nicht gefunden' },
  { en: 'Shop name is required', nl: 'Shopnaam is verplicht', de: 'Shopname ist erforderlich' },
  { en: 'Fill in all required fields', nl: 'Vul alle verplichte velden in', de: 'Fülle alle Pflichtfelder aus' },
  { en: 'Select a specific store to connect an integration', nl: 'Selecteer een specifieke store om een integratie te koppelen', de: 'Wähle einen bestimmten Store, um eine Integration zu verbinden' },
  { en: 'Could not load integrations', nl: 'Kon integraties niet laden', de: 'Integrationen konnten nicht geladen werden' },
  { en: 'Status updated', nl: 'Status bijgewerkt', de: 'Status aktualisiert' },
  { en: 'Could not update status', nl: 'Kon status niet bijwerken', de: 'Status konnte nicht aktualisiert werden' },
  { en: 'Could not update integration', nl: 'Kon integratie niet bijwerken', de: 'Integration konnte nicht aktualisiert werden' },
  { en: 'Could not connect integration', nl: 'Kon integratie niet koppelen', de: 'Integration konnte nicht verbunden werden' },
  { en: 'Could not remove integration', nl: 'Kon integratie niet verwijderen', de: 'Integration konnte nicht entfernt werden' },
  ...
  { en: 'Contract Settings', nl: 'Contract Instellingen', de: 'Vertragseinstellungen' },
  { en: 'Add a new shipping contract to your account', nl: 'Voeg een nieuw verzendcontract toe aan je account', de: 'Füge deinem Konto einen neuen Versandvertrag hinzu' },
  { en: 'Update name, API key and credentials for this contract', nl: 'Wijzig naam, API key en credentials van dit contract', de: 'Ändere Name, API-Schlüssel und Zugangsdaten für diesen Vertrag' },
  ...
  { en: 'Example: if country code `NL`, use `PostNL`.', nl: 'Voorbeeld: als landcode `NL` is, gebruik `PostNL`.', de: 'Beispiel: Wenn der Ländercode `NL` ist, verwende `PostNL`.' },
  { en: 'Example: if country code NL, use PostNL.', nl: 'Voorbeeld: als landcode NL is, gebruik PostNL.', de: 'Beispiel: Wenn der Ländercode NL ist, verwende PostNL.' },
  { en: 'Rule name', nl: 'Regelnaam', de: 'Regelname' },
  { en: 'Country (code or name)', nl: 'Land (code of naam)', de: 'Land (Code oder Name)' },
  { en: 'Select country', nl: 'Selecteer land', de: 'Land auswählen' },
  { en: 'Priority (lower = first)', nl: 'Prioriteit (lager = eerst)', de: 'Priorität (niedriger = zuerst)' },
  { en: 'Carrier', nl: 'Vervoerder', de: 'Versanddienstleister' },
